...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PUSH6_Pin */
  GPIO_InitStruct.Pin = PUSH6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(PUSH6_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SOFT_POWER_Pin PUSH1_Pin PUSH2_Pin PUSH3_Pin
                           PUSH4_Pin PUSH5_Pin */
  GPIO_InitStruct.Pin = SOFT_POWER_Pin|PUSH1_Pin|PUSH2_Pin|PUSH3_Pin
                          |PUSH4_Pin|PUSH5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
